...
<div id="cont">
    <div id="site">
        <div id="header">
            <div id="header2">
                <a id="myEvents" href="/profile/events">My Events</a>
                <a id="actiw" href="/profile/events/take/part">Take part</a>
        ...
        <div id="content">
            <c:forEach items="${events}" var="event">
                <div id="frend" onclick="window.location.assign('/event/${event.event.id}')">
                    <hr/><div style='width: 100%;float: left;margin-top: 20px; ' ><img src="${event.event.photo}" style='float: left' width='150px'><h1 >${event.event.name}</h1><p></p><p>${event.event.location}</p><p id='a1"+event.id+"'>${event.event.title}</p><div id='a2"+event.id+"' >
                    <p>${event.event.text}</p></div><div id='form"+event.id+"' style='width: 100%;height: 20px;float: right'><div id='1form"+event.id+"' style='width: 8%;height: 20px;float: left'></div><div id='2form"+event.id+"' style='width: 8%;height: 20px;float: left'>
