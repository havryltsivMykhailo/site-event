...
<div id="cont">
    <div id="site">
        <div id="header">
            <div id="header2">
            <a id="actiw" href="/friends">Friends</a>
            <a id="followers" href="/profile/followers">Followers</a>
        ...
        <div id="content">
            <c:forEach items="${friends}" var="friend">
                <div id="frend" onclick="window.location.assign('/profile/${friend.id}')">
                    <div id="photo"><img src="${friend.avatar}" width="80%" height="100%"></div>
                    <div id="user"> ${friend.secondName}   ${friend.name}</div>
 </div>
                <div id="delete"> <a href="/friend/delete/${friend.id}">Delete fiends</a></div>
            </c:forEach>
        </div>
    </div>
