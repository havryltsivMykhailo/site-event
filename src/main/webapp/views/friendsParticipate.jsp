    ...
    <div id="site">
        <div id="header">
            <div id="header2">
                ...
                <a id="actiw" href="/profile/events/involving/friends">Events involving friends</a>
            </div>
        </div>
        <div id="aside1">
        ...
        <div id="content">
            <c:forEach items="${events}" var="event">
                <div id="frend" onclick="window.location.assign('/event/${event.event.id}')">
                    <hr/><div style='width: 100%;float: left;margin-top: 20px; ' >"+p+"<h1 >${event.event.name}</h1><p></p><p>${event.event.location}</p><p id='a1"+event.id+"'>${event.event.title}</p><div id='a2"+event.id+"' >
